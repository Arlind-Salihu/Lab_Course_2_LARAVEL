...
<body class="hold-transition theme-primary" style="background:linear-gradient(45deg, #cbcbcb, #1455ff)">	
				...
				<div class="row justify-content-center no-gutters">
					<div class="col-lg-4 col-md-5 col-12">
                        ...
                        <form method="POST" action="{{ isset($guard) ? url($guard.'/login') : route('login') }}">
                            ...
                            <p class="text-white">Don't have an account?</p><a href="{{route('register')}}"><p class="text-white">Sign Up</p></a>
							</div>
                            <div class="text-center">
                                <a href="/"><p class="text-white">Sign In as Student</p></a>
                                <a href="/admin/login"><p class="text-white">Sign In as Admin</p></a>
							</div>
						</div>
					</div>
				</div>
	...
	<!-- Vendor JS -->
	<script src="{{asset('js/vendadminbackend/ors.min.js')}}"></script>
