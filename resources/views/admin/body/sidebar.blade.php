...
<aside class="main-sidebar">
    ...
    <section class="sidebar">	
				 ...
				 <a href="index.html">
				  <!-- logo for regular state and mobile devices -->
					 <div class="d-flex align-items-center justify-content-center">					 	
						  <img src="{{asset('adminbackend/images/logo.png')}}" alt="" width="50px" height="50px">
						  <h3><b>UBT SMIS</b></h3>
					 </div>
				</a>
			</div>
      ...
      <!-- Vet modifikim per url -->
          <a href="{{url('http://127.0.0.1:8000/admin/dashboard')}}">
        ...
        <li class="treeview {{ ($prefix == '/setups')?'active':'' }}">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="{{ route('student.shift.view')}}"><i class="ti-more"></i>Free Category</a></li>
          </ul>
        </li>
